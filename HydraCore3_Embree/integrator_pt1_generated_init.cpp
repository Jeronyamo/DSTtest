...
VkDescriptorSetLayout Integrator_Generated::CreatePathTraceMegaDSLayout()
{
  ...
  dsBindings[8].descriptorType     = VK_DESCRIPTOR_TYPE_ACCELERATION_STRUCTURE_KHR;
...
void Integrator_Generated::InitMemberBuffers()
{
  ...
  m_vdata.m_materialsBuffer = vk_utils::createBuffer(device, m_materials.capacity()*sizeof(struct GLTFMaterial), VK_BUFFER_USAGE_STORAGE_BUFFER_BIT | VK_BUFFER_USAGE_TRANSFER_DST_BIT);
