...
public:
  ...
  virtual void PathTraceCmd(VkCommandBuffer a_commandBuffer, uint tid, uint a_maxDepth, float4* out_color);
  virtual void NaivePathTraceCmd(VkCommandBuffer a_commandBuffer, uint tid, uint a_maxDepth, float4* out_color);
  ...
  void PathTraceBlock(uint tid, uint a_maxDepth, float4* out_color, uint32_t a_numPasses) override;
  void NaivePathTraceBlock(uint tid, uint a_maxDepth, float4* out_color, uint32_t a_numPasses) override;
  ...
  virtual void PathTraceMegaCmd(uint tid, uint a_maxDepth, float4* out_color);
  virtual void NaivePathTraceMegaCmd(uint tid, uint a_maxDepth, float4* out_color);
...
protected:
  ...
  void InitKernel_PathTraceMega(const char* a_filePath);
  ...
  void InitKernel_NaivePathTraceMega(const char* a_filePath);
  ...
  void InitKernel_PackXYMega(const char* a_filePath);
